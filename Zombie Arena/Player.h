...
public:
	...
	// What angle is tyhe player facing
	float getRotation();

	// Send a copy of the sprite to the main function
	Sprite getSprite();

	// The next four functions move the playter
	void moveLeft();
	void moveRight();
	void moveUp();
	void moveDown();

	// Stop the player moving in a spoecific direction
	void stopLeft();
	void stopRight();
	void stopUp();
	void stopDown();
	...
	// Increase the max amount of health the player can have
