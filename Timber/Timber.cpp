...
int main()
{
	...
	VideoMode vm(1920, 10980);

	// Create and open a window for the game
	RenderWindow window(vm, "Timber!!!", Style::Fullscreen);

	// Creat a texture to hold a graphiv on the GPU
	...
	// Make 3 clopud sprites from 1 texture
		...
		if (!paused)
		{
			...
			for (int i = 0; i < NUM_BRANCHES; i++)
			{
				...
				if (branchPositions[i] == side::LEFT)
				{
					...
					// Flip the sprite the other way round
				...
				else if (branchPositions[i] == side::RIGHT)
				{
					...
					// Set the sprites rotation to normal
